<div class="flex bg-center bg-cover bg-[linear-gradient(rgba(3,7,18,.7),rgba(3,7,18,1)),url(<?= $kino->img ?>)]">
    <main class="flex pb-40 pt-20 max-w-screen-xl mx-auto">
        <div class="relative bg-cover bg-center shadow-2xl shadow-gray-700/50 bg-[url(<?= $kino->img ?>)] min-w-[480px] min-h-[640px] rounded-2xl"></div>
        <div class="ml-20 mt-3">
            ...
            <p class="mt-20 text-lg text-gray-300"><?= $kino->description ?></p>
        </div>
    </main>
</div>
<div class="justify-between items-center flex max-w-screen-xl mx-auto">
    ...
    <form method="post">
        <button name="btnReview" class="bg-purple-600 px-4 py-3 rounded-lg text-gray-200 flex items-center gap-1.5">
